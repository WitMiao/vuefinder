import { inject as _t, reactive as wt, watch as ie, ref as A, computed as R, shallowRef as pn, markRaw as qn, defineComponent as te, onMounted as fe, nextTick as Be, createElementBlock as h, openBlock as u, withKeys as vt, unref as a, createElementVNode as s, createCommentVNode as L, withModifiers as ae, renderSlot as xe, toDisplayString as y, createBlock as U, resolveDynamicComponent as _n, withCtx as se, createVNode as N, Fragment as ve, renderList as pe, withDirectives as ue, vModelCheckbox as Je, vModelText as We, onUnmounted as ke, useTemplateRef as Xe, createTextVNode as ce, resolveComponent as hn, normalizeClass as ne, customRef as Gn, Teleport as yt, normalizeStyle as Oe, isRef as Wn, vModelSelect as ht, onBeforeUnmount as mn, vModelRadio as Dt, mergeProps as Ae, toHandlers as He, vShow as Ue, normalizeProps as Ke, guardReactiveProps as je, onUpdated as Yn, mergeModels as Qn, useModel as gn, Transition as Xn, provide as Jn } from "vue";
import Zn from "mitt";
...
import { computePosition as Ze, offset as rt, flip as lt, shift as dt, autoUpdate as zt } from "@floating-ui/dom";
...
function fo(n, e, t, o, i) {
  ...
  return wt({ t: $, locale: _, localeAtom: c });
}
const po = "4.0.33";
...
const bo = () => {
  const n = Fe(""), e = Fe([]), t = Fe(!1), o = Fe([]), i = Fe({ active: !1, column: "", order: "" }), l = Fe({
    ...
    let Ie = "";
    const tt = Ee.map((Se) => (Ie = Ie ? `${Ie}/${Se}` : Se, {
      basename: Se,
      name: Se,
      path: oe ? `${oe}://${Ie}` : Ie,
      type: "dir"
    ...
    if (!Le || !Ee) return oe;
    const tt = Ie === "asc" ? 1 : -1;
    return oe.slice().sort((Se, Ft) => yo(Se[Ee], Ft[Ee]) * tt);
...
const xs = { class: "vuefinder__image-preview" }, Ss = { class: "vuefinder__image-preview__header" }, Cs = ["title"], Fs = { class: "vuefinder__image-preview__actions" }, Ps = { class: "vuefinder__image-preview__image-container" }, Ds = ["src"], Ts = /* @__PURE__ */ te({
  ...
  setup(n, { emit: e }) {
    ...
    ), v = A(c.value), { addExternalFiles: f, upload: w, queue: p } = Dn(o.customUploader), S = o.fs, F = W(S.path), C = Xe("cropperRef"), m = async () => {
...
}, fi = ["download", "href"], $t = /* @__PURE__ */ te({
  __name: "ModalPreview",
  setup(n) {
  ...
  setup(n, { expose: e, emit: t }) {
    ...
    const f = (C) => {
      ...
      if (!(!d.value || !c.value) && (await Be(), !(!d.value || !c.value))) {
        ...
        try {
          const { x: C, y: m } = await Ze(d.value, c.value, {
...
const On = { render: Ka }, ja = ["title"], qa = { class: "vuefinder__search-modal__result-icon" }, Ga = { class: "vuefinder__search-modal__result-content" }, Wa = { class: "vuefinder__search-modal__result-name" }, Ya = {
  ...
  setup(n, { expose: e, emit: t }) {
    const o = n, i = t, l = ee(), { t: r } = l.i18n, d = Xe("scrollableContainer"), c = R(() => o.searchResults.length > 0), v = R(() => o.searchResults.length), f = A(0), w = A(600), p = R(() => o.searchResults.length * Ge), S = R(() => {
...
`).map((b) => b.trim()).filter(Boolean);
    ...
    }, { i18n: g } = _t("VueFinderOptions"), _ = Object.fromEntries(
      Object.entries({
        ar: "Arabic (العربيّة)",
    ...
    const e = ee(), t = De(e), { enabled: o } = ze(), { t: i } = e?.i18n || { t: (_) => _ }, l = e?.fs, r = e?.config, d = W(r.state), c = W(l.selectedItems), v = W(l?.storages || []), f = A(null), w = A(!1), p = R(() => window.opener !== null || window.name !== "" || window.history.length <= 1), S = R(() => [
      {
        ...
        items: [
          ...
          { type: "separator" },
          {
            ...
            label: i("Preview"),
            action: () => {
              c.value.length === 1 && c.value[0]?.type !== "dir" && e?.modal?.open($t, {
          ...
          ...o("copy") ? [
            ...
            },
            {
              ...
              action: () => {
                ...
                _?.items?.size > 0 && e?.modal?.open(_.type === "cut" ? et : qt, {
          ...
          ...o("move") ? [
            {
              ...
              action: () => {
                if (c.value.length > 0) {
                  ...
                  e?.modal?.open(et, { items: { from: c.value, to: k } });
                }
              },
              enabled: () => c.value.length > 0
            },
    ...
    return (m, g) => (u(), h("div", Vd, [
      s("div", Rd, [
        ...
        a(t)("rename") ? (u(), h("div", {
          ...
          class: "mx-1.5",
          title: a(o)("Rename"),
          onClick: g[2] || (g[2] = ($) => a(d).length !== 1 || a(e).modal.open(kt, { items: a(d) }))
        }, [
          N(a(Pn), {
        ...
        a(t)("delete") ? (u(), h("div", {
          ...
          class: "mx-1.5",
          title: a(o)("Delete"),
          onClick: g[3] || (g[3] = ($) => !a(d).length || a(e).modal.open(bt, { items: a(d) }))
        }, [
          N(a(Fn), {
...
function ft(n, e = []) {
  ...
  function v(w, p) {
    ...
    o.clearDraggedItem(), n.modal.open(et, { items: { from: g, to: p } });
  }
  function f(w) {
    return {
      dragover: (p) => r(p, w),
...
const Gc = { class: "vuefinder__breadcrumb__container" }, Wc = ["title"], Yc = ["title"], Qc = ["title"], Xc = ["title"], Jc = { class: "vuefinder__breadcrumb__path-container" }, Zc = { class: "vuefinder__breadcrumb__list" }, eu = {
  ...
  setup(n) {
    ...
    const k = ft(e, ["vuefinder__drag-over"]);
    function x(I = null) {
      I ??= F.value.length - 2;
      const T = {
...
function qu(n) {
  const {
    ...
    const Ie = Math.max(0, K), tt = Math.min(Q, Ee), Se = o(
      F.value,
      Ie,
      tt,
      Zt,
...
const Ju = { class: "vuefinder__explorer__container" }, Zu = {
  ...
  setup(n) {
    const e = n, t = ee(), o = ft(t, ["vuefinder__drag-over"]), i = Xe("dragImage"), l = pn(null), r = Xe("scrollContainer"), d = Xe("scrollContent"), c = t.fs, v = t.config, f = W(v.state), w = W(c.sortedFiles), p = W(c.selectedKeys), S = W(c.loading), F = (Z) => p.value?.has(Z) ?? !1, C = R(() => {
        ...
        if (!(!t.value || !l))
          try {
            i = zt(l, t.value, async () => {
              if (!(!l || !t.value))
                try {
                  const { x: b, y: D } = await Ze(l, t.value, {
                    placement: "right-start",
                    strategy: "fixed",
                    middleware: m
                  });
...
const wv = { class: "vuefinder__folder-loader-indicator" }, yv = {
  ...
  setup(n) {
    const e = ee(), t = e.fs, o = ft(e, ["vuefinder__drag-over"]), i = A({}), l = e.config, r = W(l.state), { t: d } = e.i18n, c = W(t.path), v = n, f = A(null), w = A(50);
    fe(() => {
  ...
  setup(n) {
    ...
    ), c = ft(e, ["vuefinder__drag-over"]), v = W(t.path), f = R(() => i.storage === v.value?.storage);
    ie(
      () => ({
  ...
  __name: "TreeView",
  setup(n) {
    const e = ee(), { enabled: t } = ze(), { t: o } = e.i18n, { getStore: i, setStore: l } = e.storage, r = e.fs, d = e.config, c = W(d.state), v = W(r.sortedFiles), f = W(r.storages), w = R(() => f.value || []), p = W(r.path), S = ft(e, ["vuefinder__drag-over"]), F = A(190), C = A(i("pinned-folders-opened", !0));
...
const jn = [
  ...
  },
  {
    id: be.preview,
    title: ({ t: n }) => n("Preview"),
    action: (n, e) => n.modal.open($t, { storage: e[0]?.storage, item: e[0] }),
    show: it(
  ...
  setup(n, { emit: e }) {
    const t = e, o = n, i = ee(), l = Xe("root"), r = i.config;
    ie(
      () => o.features,
      (g) => {
        const $ = yn(g);
